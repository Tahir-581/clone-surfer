...
preprocessed_description = preprocess_content(description)
...
print(f"\nPreprocessed description: {preprocessed_description}")
print(f"\nPreprocessed content (first 200 chars): {preprocessed_content[:200]}...")
...
for entity in test_entities:
    ...
    # Check in title
    title_words = preprocessed_title.lower().split()
    ...
    desc_words = preprocessed_description.lower().split()
    ...
    # Check in first 10%
    content_words = preprocessed_content.split()
